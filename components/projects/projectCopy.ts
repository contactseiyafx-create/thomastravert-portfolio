...
> = {
  ...
  "nike-wild-run": {
    subtitle: "Nike Wild Runのための架空広告キャンペーン",
    category: "アートディレクション",
    shortDescription: "Nike Wild Runのエネルギーから構築した\n架空の広告キャンペーン",
    longDescription:
      "Nike Wild Runは、Nikeの表現豊かなランニングコレクションを題材にした架空の広告キャンペーンです。大胆なパターン、エネルギッシュなカラーパレット、Wild Runアパレルラインの実験的な精神に着想を得て、デジタル広告、SNS、リテール空間、屋外コミュニケーションまで展開できるキャンペーンエコシステムを探求しました。",
    client: "自主制作コンセプトプロジェクト",
    role: ["アートディレクション", "グラフィックデザイン", "キャンペーンデザイン"],
    deliverables: [
      "キャンペーンキービジュアル",
      "SNS広告",
      "Instagramストーリーズ",
    ...
    disclaimer:
      "自主制作のコンセプトプロジェクトです。ポートフォリオ掲載を目的として制作した架空の広告キャンペーンです。",
  },
  "xbox-wire": {
